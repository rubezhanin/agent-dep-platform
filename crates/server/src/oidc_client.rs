...
pub trait OidcClient: Send + Sync {
    ...
    fn authorize_url(&self, state: &str, code_challenge: &str, nonce: &str) -> CoreResult<String>;
...
impl OidcClient for RealOidcClient {
    fn authorize_url(&self, state: &str, code_challenge: &str, nonce: &str) -> CoreResult<String> {
        ...
        let base = if self.config.redirect_uri.is_empty() {
            ...
            // the IdP (operator's
            // responsibility).
            self.config.redirect_uri.replace("/callback", "/authorize")
        };
...
mod tests {
    ...
    fn real_authorize_url_includes_pkce_s256_challenge_method() {
        ...
        let cfg = OidcConfig {
            ...
            redirect_uri: "https://app.example.com/v1/auth/oidc/callback".to_string(),
